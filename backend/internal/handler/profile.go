...
func (h *ProfileHandler) GetPreferences(w http.ResponseWriter, r *http.Request) {
	...
	prefs, err := h.profileSvc.GetPreferences(r.Context(), userID)
	if err != nil {
...
func (h *ProfileHandler) UpdatePreferences(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.profileSvc.UpdatePreferences(r.Context(), &prefs); err != nil {
		respondError(w, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *ProfileHandler) UpdateProfile(w http.ResponseWriter, r *http.Request) {
	...
	user, err := h.profileSvc.UpdateProfile(r.Context(), userID, req.DisplayName)
	if err != nil {
		switch {
...
func (h *ProfileHandler) GetProfile(w http.ResponseWriter, r *http.Request) {
	...
	user, err := h.profileSvc.GetProfile(r.Context(), userID)
	if err != nil {
...
func (h *ProfileHandler) GetProgress(w http.ResponseWriter, r *http.Request) {
	...
	progress, err := h.profileSvc.GetProgress(r.Context(), userID, mediaID)
	if err != nil {
		if errors.Is(err, service.ErrNotFound) {
...
func (h *ProfileHandler) UpdateProgress(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.profileSvc.UpdateProgress(r.Context(), userID, mediaID, req.Position, req.Completed); err != nil {
		respondError(w, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *ProfileHandler) ToggleFavorite(w http.ResponseWriter, r *http.Request) {
	...
	isFavorite, err := h.profileSvc.ToggleFavorite(r.Context(), userID, mediaID)
	if err != nil {
		respondError(w, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *ProfileHandler) ListRecentlyWatched(w http.ResponseWriter, r *http.Request) {
	...
	items, err := h.profileSvc.ListRecentlyWatched(r.Context(), userID, limit)
	if err != nil {
		respondError(w, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *ProfileHandler) ContinueWatching(w http.ResponseWriter, r *http.Request) {
	...
	items, err := h.profileSvc.ContinueWatching(r.Context(), userID, limit)
	if err != nil {
		respondError(w, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *ProfileHandler) NextUp(w http.ResponseWriter, r *http.Request) {
	...
	items, err := h.profileSvc.NextUp(r.Context(), userID, limit)
	if err != nil {
		respondError(w, http.StatusInternalServerError, err.Error())
		return
	}
...
func (h *ProfileHandler) DismissProgress(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.profileSvc.DismissProgress(r.Context(), userID, mediaID); err != nil {
		respondError(w, http.StatusInternalServerError, err.Error())
		return
	}
